...
- Advanced sorting options (ID, Name, Stats)
- Responsive grid layout

### Interactive UI Components
- Detailed Pokémon cards with hover effects
...
```bash
git clone https://github.com/pkparthk/pokemon-explorer.git
```
